...
def opcao3():
    ...
    if option == '1':
        ...
        print(f'Número quântico final (ni): {ni:.2f}')
    elif option == '2':
        ...
        ni = round((-13.6/Ei) ** 0.5)                        
        print('Número quântico inicial (ni):', ni)
        print(f'Número quântico final (n): {ni:.2f}')
    elif option == '3':
        ...
        print(f'Número quântico final (nf): {nf:.2f}')
    elif option == '4':
...
def opcao4():
    ...
    print('1 - ache o n final usando  f') 
    print('2 - ache o n final usando lF ')
    # Retorna n inicial
    print('3 - ache o n inicial usando  f')
    print('4 - ache o n inicial usando lF')
    option = input('Escolha uma opção: ')
    if option == '1':
        print('Opção 1 selecionada...')
        n = float(input('Digite o número quântico (n): '))
        freq_foton = float(input('Digite a frequência (f) em Hz: '))
